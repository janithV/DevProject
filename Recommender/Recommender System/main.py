...
class test():
    ...
    def getRecommendations(self,id):

        engine = sqlalchemy.create_engine(
        'mysql+pymysql://root:@localhost:3306/recommenderdb')
...
class HelloWorld(Resource):
    ...
    def get(self,id):
        obj=test()
        sim_users=obj.getRecommendations(id)
        return sim_users


api.add_resource(HelloWorld, "/getrecommendations/<string:id>")
